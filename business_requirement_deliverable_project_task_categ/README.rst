...
This module introduces use OCA/project **Task Category Main** in the business requirements resource lines.

Extend module business_requirement_project to be have main category propagated 
