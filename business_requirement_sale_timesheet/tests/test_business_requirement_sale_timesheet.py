...
from odoo.addons.business_requirement_sale.tests.test_business_requirement_sale import (
    TestBusinessRequirementSaleBase,
)
...
class TestBusinessRequirementSaleTimesheet(TestBusinessRequirementSaleBase):
    ...
    def setUpClass(cls):
        super().setUpClass()
        cls.product1.write({"type": "service", "service_tracking": "task_in_project"})
